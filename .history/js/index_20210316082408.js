...
searchInput.addEventListener('change', (e) => {
  fetch(
    `api.openweathermap.org/data/2.5/weather?q=${e.target.value},uk&APPID=${APP_ID}&units=metric&lang=en``https://api.openweathermap.org/data/2.5/weather?q=${e.target.value}&appid=${APP_ID}&units=metric&lang=en`
  ).then(async (res) => {
